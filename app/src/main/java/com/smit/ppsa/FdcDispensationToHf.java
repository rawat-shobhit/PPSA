...
public class FdcDispensationToHf extends AppCompatActivity {

   // EditText fdc2, fdc3, fdc4, ethambutol;
    ...
    FdcDispensationToHfViewModel mViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fdc_dispensation_to_hf);
        dataBase = AppDataBase.getDatabase(this);
        mViewModel = new ViewModelProvider(this).get(FdcDispensationToHfViewModel.class);
        progressDialog = new GlobalProgressDialog(this);
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(this);

        if (BaseUtils.getTuIdFdc(FdcDispensationToHf.this).equals(getIntent().getStringExtra("tu_id")) && BaseUtils.getHfIdFdc(FdcDispensationToHf.this).equals(getIntent().getStringExtra("hf_id"))) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FdcDispensationToHf.super.onBackPressed();
            }
        });
    ...
    private void getMedicines() {
        ...
        if (!BaseUtils.isNetworkAvailable(FdcDispensationToHf.this)) {
            Toast.makeText(FdcDispensationToHf.this, "Please Check your internet  Connectivity", Toast.LENGTH_SHORT).show();
            //   LocalBroadcastManager.getInstance(CounsellingForm.this).sendBroadcast(new Intent().setAction("").putExtra("setRecycler", ""));
            progressDialog.hideProgressBar();
            return;
        }
        BaseUtils.putPatientName(FdcDispensationToHf.this, getIntent().getStringExtra("patient_name"));

        //  Log.d("dkl9", "getPatientdd: " + getIntent().getStringExtra("hf_id"));
        Log.d("dkl9", "getPatiena: " + BaseUtils.getUserInfo(FdcDispensationToHf.this).getnUserLevel());
    ...
    private void getRoomUOM() {
        ...
        uomFromRoom.observe(FdcDispensationToHf.this, roomUOMS -> {
    ...
    private void getRoomMedicines() {
        ...
        medicinesFromRoom.observe(FdcDispensationToHf.this, roomMedicines -> {
    ...
    private void setSpinnerAdapter(Spinner spinner, List<String> values) {
        ...
        CustomSpinnerAdapter spinnerAdapter = new CustomSpinnerAdapter(FdcDispensationToHf.this, values);
    ...
    private void setUpDispensationCalender() {
        ...
        dispensationDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog m_date = new DatePickerDialog(FdcDispensationToHf.this, R.style.calender_theme, trdate, trCalendar
    ...
    private void setRecycler() {
        previousAdapter = new DispensationHfAdapter(parentDataPreviousSamples, FdcDispensationToHf.this);
    ...
    private void getPreviousSamples() {
        ...
        //  Log.d("dkl9", "getPatientdd: " + getIntent().getStringExtra("hf_id"));
        Log.d("dkl9", "getPreviousSamples: " + BaseUtils.getUserInfo(FdcDispensationToHf.this).getnUserLevel());
            ...
            public void onResponse(Call<DispensationHfResponse> call, Response<DispensationHfResponse> response) {
                if (response.isSuccessful()) {
                    if (response.body().getStatus().equals("true")) {
                        ...
                        BaseUtils.putTuidFdc(FdcDispensationToHf.this, getIntent().getStringExtra("tu_id"));
                        BaseUtils.putHfidFdc(FdcDispensationToHf.this, getIntent().getStringExtra("hf_id"));
                        ...
                        LocalBroadcastManager.getInstance(FdcDispensationToHf.this).sendBroadcast(new Intent().setAction("").putExtra("setRecycler", ""));
    ...
    private void getRoomPreviousSamples() {
        ...
        roomPreviousSamplesHf.observe(FdcDispensationToHf.this, roomPreviousSamplesHfs -> {
                ...
                if (!uom.equals("")) {
                    if (isNotEmpty(quantity)) {
                        //if (isNotEmpty(ethambutol)) {
                            progressDialog.showProgressBar();
                            mViewModel.submitFdcDispensationToHf(
