...
public class CounsellingPreviousSampleAdapter extends RecyclerView.Adapter<CounsellingPreviousSampleAdapter.Mholder> {
    private List<com.smit.ppsa.Response.CounsellingResponse.UserData> ParentData = new ArrayList<>();
    private Context context;
    int prevPos = -1;

    public CounsellingPreviousSampleAdapter(List<com.smit.ppsa.Response.CounsellingResponse.UserData> ParentData, Context context) {
    ...
    public void onBindViewHolder(@NonNull Mholder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.date.setText(ParentData.get(position).getD_reg_dat());
    ...
    public void updateList(ArrayList<com.smit.ppsa.Response.previoussamplesformsix.UserData> list) {
       // ParentData = list;
