package com.smit.ppsa.sampleCollectionSampleFolder;
...
public class sampleCollectionAdapter extends RecyclerView.Adapter<sampleCollectionAdapter.Mholder> {
    private List<SampleData> nList;
    private Activity context;

    public sampleCollectionAdapter(List<SampleData> registerParentData, Activity context) {
    ...
    @NonNull
    @Override
    public sampleCollectionAdapter.Mholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new sampleCollectionAdapter.Mholder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_sample,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull sampleCollectionAdapter.Mholder holder, @SuppressLint("RecyclerView") int position) {
