...
@Entity(tableName = "roomFdcDispensationHf")
public class RoomFdcDispensationHf {
    ...
    public RoomFdcDispensationHf(int n_st_id, int n_dis_id, int n_tu_id, int n_hf_id, int n_doc_id, String d_issue, int n_fdc2, int n_fdc3, int n_fdc4, int n_etham, String n_lat, String n_lng, int n_staff_info, int n_user_id) {
