...
@Entity(tableName = "roomFdcDispensationPatient")
public class RoomFdcDispensationPatient {
    ...
    public RoomFdcDispensationPatient(int n_st_id, int n_dis_id, int n_tu_id, int n_hf_id, int n_doc_id, int n_enroll_id, String d_issue, int n_fdc2, int n_fdc3, int n_fdc4, int n_etham, String n_lat, String n_lng, int n_staff_info, int n_user_id) {
    ...
    public int getN_enroll_id() {
        return n_enroll_id;
    }

    public void setN_enroll_id(int n_enroll_id) {
        this.n_enroll_id = n_enroll_id;
    }
