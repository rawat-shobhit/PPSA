...
public class DoctorModel {
    ...
    public DoctorModel(String n_hf_id, String c_doc_nam, String c_regno, String n_qual_id, String n_spec_id, String c_mob) {
        this.n_hf_id = n_hf_id;
        this.c_doc_nam = c_doc_nam;
        this.c_regno = c_regno;
    ...
    public String getC_regno() {
        return c_regno;
    }

    public void setC_regno(String c_regno) {
        this.c_regno = c_regno;
    }
